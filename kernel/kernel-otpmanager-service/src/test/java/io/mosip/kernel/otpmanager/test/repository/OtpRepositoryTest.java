...
public class OtpRepositoryTest {
    ...
    @Test
    public void testFindFirstByRefIdOrderByGeneratedDtimesDesc_returnsLatest() {
    ...
    @Test
    public void testFindFirstByRefIdOrderByGeneratedDtimesDesc_emptyWhenNoMatch() {
        List<OtpEntity> result = em.createQuery("SELECT o FROM OtpEntity o WHERE o.refId = :refId ORDER BY o.generatedDtimes DESC", OtpEntity.class)
                .setParameter("refId", "non-existing-ref")
                .setMaxResults(1)
                .getResultList();
